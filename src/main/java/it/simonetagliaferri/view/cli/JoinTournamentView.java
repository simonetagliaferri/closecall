...
public class JoinTournamentView {
    ...
    public int listTournaments(List<TournamentBean> tournaments) {
        ...
        for (TournamentBean tournament : tournaments) {
            ...
            CliUtils.println(tournament.getClubName());
            CliUtils.println("");
            tournamentsCount++;
        }
    ...
    public String tournamentByCity() {
        return CliUtils.prompt("Please enter the city you would like to enter a tournament in: ");
    }
